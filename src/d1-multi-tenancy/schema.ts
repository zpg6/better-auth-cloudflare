 ...
 * Note: id field is auto-generated by Better Auth, tenant_id stores the actual tenant identifier
 */
export type Tenant = {
    id: string; // Auto-generated primary key by Better Auth
    tenant_id: string; // Organization ID or User ID depending on mode
